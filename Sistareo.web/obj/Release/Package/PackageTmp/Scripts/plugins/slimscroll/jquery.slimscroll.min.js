...
(function (f) {
    jQuery.fn.extend({
        slimScroll: function (h) {
            var a = f.extend({ width: "auto", height: "250px", size: "8px", color: "#000", position: "right", distance: "1px", start: "top", opacity: 0.2, alwaysVisible: !0, disableFadeOut: !1, railVisible: !0, railColor: "#333", railOpacity: 0.1, railDraggable: !0, railClass: "slimScrollRail", barClass: "slimScrollBar", wrapperClass: "slimScrollDiv", allowPageScroll: !1, wheelStep: 20, touchScrollStep: 200, borderRadius: "0px", railBorderRadius: "0px" }, h); this.each(function () {
                function r(d) {
                    if (s) {
                        d = d ||
